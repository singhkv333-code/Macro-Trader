...
const COUNTRIES = [
  {
    ...
    profile: {
      ...
      startingRevenue: 141.4, startingDebtService: 30.0, startingNetBudget: 111.4,
      startingGdpBillions: 1040, startingGdpGrowth: 6.2,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 202.4, startingDebtService: 22.0, startingNetBudget: 180.4,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 176.0, startingDebtService: 24.8, startingNetBudget: 151.2,
      startingGdpBillions: 1100, startingGdpGrowth: 4.8,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 199.0, startingDebtService: 17.1, startingNetBudget: 181.9,
      startingGdpBillions: 1070, startingGdpGrowth: 0.8,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 193.0, startingDebtService: 15.9, startingNetBudget: 177.1,
      startingGdpBillions: 1060, startingGdpGrowth: 1.1,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 132.6, startingDebtService: 23.6, startingNetBudget: 109.0,
      startingGdpBillions: 1020, startingGdpGrowth: 2.9,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 194.4, startingDebtService: 23.3, startingNetBudget: 171.1,
      startingGdpBillions: 1080, startingGdpGrowth: 1.5,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 121.5, startingDebtService: 11.8, startingNetBudget: 109.7,
      startingGdpBillions: 980, startingGdpGrowth: 2.0,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 184.8, startingDebtService: 16.0, startingNetBudget: 168.8,
      startingGdpBillions: 1050, startingGdpGrowth: 2.2,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 150.0, startingDebtService: 8.8, startingNetBudget: 141.2,
      startingGdpBillions: 1000, startingGdpGrowth: 3.5,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 82.8, startingDebtService: 19.3, startingNetBudget: 63.5,
      startingGdpBillions: 920, startingGdpGrowth: 3.0,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 193.0, startingDebtService: 14.8, startingNetBudget: 178.2,
      startingGdpBillions: 1060, startingGdpGrowth: 2.5,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 138.6, startingDebtService: 15.2, startingNetBudget: 123.4,
      startingGdpBillions: 990, startingGdpGrowth: 4.0,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 171.0, startingDebtService: 6.8, startingNetBudget: 164.2,
      startingGdpBillions: 900, startingGdpGrowth: 1.2,
  ...
  },
  {
    ...
    profile: {
      ...
      startingRevenue: 121.2, startingDebtService: 20.2, startingNetBudget: 101.0,
      startingGdpBillions: 1010, startingGdpGrowth: 3.2,
